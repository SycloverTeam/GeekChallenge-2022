...
function show_img($img) {
    echo "<img alt=\"150x150\" src=\"lib/img/{$img}\"/>"."<br>";
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="right">
        ...
        <div class="content">
            ...
            <div class="col-md-12">
                <ul class="thumbnails">
                    <li>
                        <a class="group1" href="lib/img/gallery/1.jpg" title="Group photo 1">
                        <?php show_img('i_changfen.jpg'); ?>
                        </a>
                        <div class="options">
                            <a href="buy.php?dish=changfen"><button type="button" class="btn btn-info btn-app btn-xs btn-circle">下单</button></a>
                        </div>
                    </li>
                </ul>
                ...
                <ul class="thumbnails">
                    <li>
                        <a class="group1" href="lib/img/gallery/1.jpg" title="Group photo 1">
                        <?php show_img('i_fengzhua.jpg'); ?>
                        </a>
                        <div class="options">
                            <a href="buy.php?dish=fengzhua"><button type="button" class="btn btn-info btn-app btn-xs btn-circle">下单</button></a>
                        </div>
                    </li>
                </ul>
                ...
                <ul class="thumbnails">
                    <li>
                        <a class="group1" href="lib/img/gallery/1.jpg" title="Group photo 1">
                        <?php show_img('i_pdsrzhou.jpg'); ?>
                        </a>
                        <div class="options">
                            <a href="buy.php?dish=pdsrzhou"><button type="button" class="btn btn-info btn-app btn-xs btn-circle">下单</button></a>
                        </div>
                    </li>
                </ul>
                ...
                <ul class="thumbnails">
                    <li>
                        <a class="group1" href="lib/img/gallery/1.jpg" title="Group photo 1">
                        <?php show_img('i_spspnai.png'); ?>
                        </a>
                        <div class="options">
                            <a href="buy.php?dish=spspnai"><button type="button" class="btn btn-info btn-app btn-xs btn-circle">下单</button></a>
                        </div>
                    </li>
                </ul>
...
<script>
    $(document).ready(function () {
        $('a[href="order.php"]').addClass('active').parent().parent().addClass('in');
